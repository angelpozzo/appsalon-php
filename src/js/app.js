...
function iniciarApp() {
    ...
    tabs(); // Cambia la seccion cuando se presione llos tabs
    ...
    seleccionarHora(); // añade la hora de la cita en objeto
...
function tabs() {
    // Agrega y cambia la variable de paso segu el tab seleccionado
...
function seleccionarServicio(servicio) {
    ...
    // Identificar al elemtno que se da click
